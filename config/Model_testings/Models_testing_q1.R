...
setwd("~/Documents/Thesis/NanoASV/Software_dev/NanoASV/config/Tests_with_real_dataset/Tree_fixed/")

load("map-ont-tree-fixed.out/Results/Rdata/NanoASV.rdata")
mapont <- NanoASV
mapont@sam_data <- sample_data(data.frame(mapont@sam_data,
                                          model = "map-ont"))
load("asm10-tree-fixed.out/Results/Rdata/NanoASV.rdata")
asm10 <- NanoASV
asm10@sam_data <- sample_data(data.frame(asm10@sam_data,
                                          model = "asm10"))
load("asm5-tree-fixed.out/Results/Rdata/NanoASV.rdata")
asm5 <- NanoASV
...
#save(Genus, Family, Order, Class, Phylum, file = "q1_Tax_glom_taxo_levels.rdata")

load("q1_Tax_glom_taxo_levels.rdata")
...
pdf("q1_Numerical_richness.pdf", he =18, wi = 18)
...
pdf("q1_shannon_index", he =18, wi = 18)
...
pdf("q1_Sample_sums_barplot.pdf", he = 6, wi = 12)
...
pdf("q1_Composition_with_different_models.pdf", he = 8, wi = 16)
